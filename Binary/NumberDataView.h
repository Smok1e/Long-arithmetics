...
public:
	...
	NumberDataView (const char* begin, const char* end);
...
NumberDataView::NumberDataView (const char* begin, const char* end) :
	m_begin (const_cast <char*> (begin)),
	m_end   (const_cast <char*> (end  ))
{}
